-- AIMLOCK DO EZEK v18.4 - DASH ATUALIZA SEMPRE
...
-- ══════════════════════════════════════════════════
-- 🔥 FORÇA ATUALIZAÇÃO CONSTANTE DA DIREÇÃO (NOVO)
-- ══════════════════════════════════════════════════
...
atualizarStatus()
print("✅ AIMLOCK DO EZEK v18.4!")
print("🔥 Dash força direção TODO frame")
